import { Home, MessageSquare, FileText, GitBranch, AppWindow, Clock, Puzzle, Settings } from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'pipelines', path: '/pipelines', label: 'Pipelines', icon: GitBranch },
