...
| [Azure AI Speech dictation](/docs/guides/azure-ai-speech-dictation) | Voice dictation through the Azure AI Services Fast Transcription API. Supports API keys and Microsoft Entra ID. | `AZURE_SPEECH_ENDPOINT`, `AZURE_SPEECH_KEY` (optional), `AZURE_SPEECH_AD_TOKEN` (optional), `AZURE_SPEECH_LOCALE` (optional) |
