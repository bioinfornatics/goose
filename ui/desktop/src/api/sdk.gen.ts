...
export const listPipelines = <ThrowOnError extends boolean = false>(options?: Options<ListPipelinesData, ThrowOnError>) => (options?.client ?? client).get<ListPipelinesResponses, unknown, ThrowOnError>({ url: '/pipelines', ...options });
...
export const executePipelineHandler = <ThrowOnError extends boolean = false>(options: Options<ExecutePipelineHandlerData, ThrowOnError>) => (options.client ?? client).post<ExecutePipelineHandlerResponses, ExecutePipelineHandlerErrors, ThrowOnError>({
