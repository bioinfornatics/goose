...
| [Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-models/how-to/deploy-models-serverless) | Serverless (MaaS) model endpoints in Azure AI Foundry — Phi-4, Mistral, Llama, Cohere, and others. Supports both API key and Entra ID (DefaultAzureCredential) authentication. See the [Azure AI Foundry guide](/docs/guides/azure-foundry-provider) for setup details. | `AZURE_FOUNDRY_ENDPOINT`, `AZURE_FOUNDRY_API_KEY` (optional — omit to use Entra ID) |
