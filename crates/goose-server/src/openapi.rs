...
#[openapi(
    paths(
        ...
        super::routes::config_management::get_reasoning_effort,
        super::routes::config_management::set_reasoning_effort,
        super::routes::config_management::get_reasoning_effort_overrides,
        super::routes::config_management::set_reasoning_effort_overrides,
        ...
        super::routes::user_auth::oidc_refresh,
        // ACP Discovery
    ...
    components(schemas(
        ...
        super::routes::config_management::SetReasoningEffortRequest,
        super::routes::config_management::ReasoningEffortResponse,
        super::routes::config_management::ReasoningEffortOverride,
        super::routes::config_management::ReasoningEffortOverridesResponse,
        super::routes::config_management::SetReasoningEffortOverridesRequest,
        goose::model::ReasoningEffort,
        ...
        super::routes::user_auth::OidcRefreshRequest,
        super::routes::user_auth::OidcRefreshResponse,
